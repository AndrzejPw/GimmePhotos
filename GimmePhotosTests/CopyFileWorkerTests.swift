...
class CopyFileWorkerTests: XCTestCase {
    func testGuessingFileNames() {
        ...
        XCTAssertEqual(guessedFiles[0], "IMG_02302.jpg")
        XCTAssertEqual(guessedFiles[1], "IMG_121.raw")
    }
    ...
    func testGuessingFileNames_reverseOrder() {
        ...
        XCTAssertEqual(guessedFiles[0], "IMG_121.raw")
        XCTAssertEqual(guessedFiles[1], "IMG_02302.jpg")
    }
    ...
    func testGuessingFileNames_LowerNumberMoreImportant() {
        ...
        XCTAssertEqual(guessedFiles[0], "IMG_3302.jpg")
    }
    
    func testGuessingFileNames_ComplexCase_OnlyStrongMatchReturned() {
        let fileNames = ["IMG_3021.jpg","IMG_3302.jpg"]
